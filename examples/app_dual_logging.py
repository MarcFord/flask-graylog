...
from flask_network_logging import GraylogExtension, GCPLogExtension
...
# Initialize both logging extensions
graylog = GraylogExtension(app)
gcp_log = GCPLogExtension(app)

# Setup logging for both extensions
...
def home():
    ...
    return jsonify({
        ...
        'version': '1.0.0',
        'logging_backends': ['Graylog', 'Google Cloud Logging'],
        'endpoints': [
            '/users',
            '/products', 
            '/test-logs',
...
def test_logs():
    ...
    return jsonify({
        ...
        'note': 'Check your Graylog and Google Cloud Logging for these messages'
    })
