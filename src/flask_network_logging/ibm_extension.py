...
class IBMLogExtension:
    ...
    def _get_config_from_app(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'IBM_INDEX_META': self.app.config.get('IBM_INDEX_META', os.getenv('IBM_INDEX_META', 'false').lower() == 'true'),
        ...
        try:
            ...
            for key, value in record.__dict__.items():
                if key not in ['name', 'msg', 'args', 'levelname', 'levelno', 'pathname', 
                              ...
                              'processName', 'process', 'getMessage', 'stack_info', 'exc_info', 'exc_text']:
    ...
    def _send_log_data(self, payload: Dict[str, Any]):
        ...
        try:
            ...
            headers = {
                ...
                'User-Agent': 'flask-network-logging-ibm/1.0.0'
            }
