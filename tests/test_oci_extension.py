...
class TestOCILogExtension:
    ...
    def test_init_app(self):
        ...
        app = Flask(__name__)
        app.config.update({"OCI_CONFIG_PROFILE": "DEFAULT", "OCI_LOG_ID": "ocid1.log.oc1...", "OCI_LOG_LEVEL": "DEBUG"})
    ...
    def test_setup_logging(self, mock_oci):
        ...
        app = Flask(__name__)
        app.config.update({"OCI_ENVIRONMENT": "oci", "OCI_LOG_ID": "ocid1.log.oc1...", "OCI_LOG_LEVEL": "INFO"})
    ...
    def test_configure_logger_with_handler(self, mock_oci):
        ...
        extension = OCILogExtension()
        extension.app = app
        extension.config = {"OCI_LOG_ID": "ocid1.log.oc1...", "OCI_SOURCE": "test-app"}
        extension.logging_client = Mock()
...
class TestOCILoggingHandler:
    ...
    def test_init(self):
        ...
        mock_client = Mock()
        handler = OCILoggingHandler(client=mock_client, log_id="ocid1.log.oc1...", source="test-app")
    ...
    def test_send_log_data_without_oci(self):
        ...
        handler = OCILoggingHandler(client=Mock(), log_id="ocid1.log.oc1...", source="test-app")
    ...
    def test_send_log_data_success(self, mock_oci):
        ...
        log_entry = {"message": "test message", "timestamp": "2023-01-01T00:00:00Z", "level": "INFO"}
    ...
    def test_send_log_data_with_optional_params(self, mock_oci):
        ...
        mock_client = Mock()
        handler = OCILoggingHandler(client=mock_client, log_id="ocid1.log.oc1...", source="custom-source")
